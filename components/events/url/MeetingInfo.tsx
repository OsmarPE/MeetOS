...
type EventDetailsProps = Pick<Event, 'title'|'duration' | 'type' | 'created_at'> & {
    username: string,
    date: Date
}

export default function MeetingInfo({  username, title, duration, type, created_at, date }: EventDetailsProps) {
